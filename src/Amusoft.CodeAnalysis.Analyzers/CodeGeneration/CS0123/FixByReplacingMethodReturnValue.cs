...
namespace Amusoft.CodeAnalysis.Analyzers.CodeGeneration.CS0123
{
	...
	public class FixByReplacingMethodReturnValue : CodeFixProviderBase
	{
		...
		protected override string GetTitle(SyntaxNode rootNode)
		{
			...
			return string.Format(Resources.MessageFormat_CS0123_FixByReplacingMethodReturnValue_0_1, member, typeName);
		}
